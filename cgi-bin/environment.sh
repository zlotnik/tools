...
export BOOKMAKER_OFFER_DOWNLOADER_UNIT_TEST_DIRECTORY=$BOOKMAKER_OFFER_DOWNLOADER_MODULE_DIRECTORY/tests
...
export DATA_DIRECTORY=$GIT_ROOT_DIRECTORY/data
...
export PERL5LIB=$PERL5LIB:$BOOKMAKER_OFFER_DOWNLOADER_MODULE_DIRECTORY/tests/BetexplorerParser
export PERL5LIB=$PERL5LIB:$BOOKMAKER_OFFER_DOWNLOADER_MODULE_DIRECTORY/tests/HTML_EventsTableParser

export PS1='[\u@\h \W]\$\$'

export PATH=$BACKEND_ROOT_DIRECTORY/bin:$PATH
