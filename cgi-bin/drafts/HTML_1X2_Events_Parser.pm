...
{ 
	...
	if ($tagname eq 'td') 
	{
		...
		if(td_number_in_tr_STATE == 5)
		{
			print 
		}
		if(td_number_in_tr_STATE == 6)
		{
...
<tbody>
	<tr data-bid="417" data-originid="1" class=" odd">
		<td class="h-text-left over-s-only"><a href="/bookmaker/1039/http://refparrknf.top/L?tag=s_144205m_355c_&amp;site=144205&amp;ad=355" onclick="dataLayer.push({'event-name': '1xBet', 'event': 'bookmaker-click', 'event-sport': 'soccer'}); return true;" target="_blank" class="in-bookmaker-logo-link in-bookmaker-logo-link--primary l417" data-bid="1039">1xBet</a></td>
		<td class="h-text-left under-s-only"><a href="/bookmaker/1039/http://refparrknf.top/L?tag=s_144205m_355c_&amp;site=144205&amp;ad=355" onclick="dataLayer.push({'event-name': '1xBet', 'event': 'bookmaker-click', 'event-sport': 'soccer'}); return true;" target="_blank" data-bid="1039"><span class="in-bookmaker-logo l417" title="1xBet"></span></a></td>
	...
	<tr data-bid="16" data-originid="1" class=" even">
		<td class="h-text-left over-s-only"><a href="/bookmaker/11/http://www.bet365.com/olp/open-account?affiliate=365_021894" onclick="dataLayer.push({'event-name': 'bet365', 'event': 'bookmaker-click', 'event-sport': 'soccer'}); return true;" target="_blank" class="in-bookmaker-logo-link in-bookmaker-logo-link--primary l16" data-bid="11">bet365</a></td>
		<td class="h-text-left under-s-only"><a href="/bookmaker/11/http://www.bet365.com/olp/open-account?affiliate=365_021894" onclick="dataLayer.push({'event-name': 'bet365', 'event': 'bookmaker-click', 'event-sport': 'soccer'}); return true;" target="_blank" data-bid="11"><span class="in-bookmaker-logo l16" title="bet365"></span></a></td>
		<td class="h-text-left tablet-desktop-only"></td>
		<td class="h-text-right">&nbsp;</td>
...
#$parser->parse_file('exampleOfOut');
sub parse()
{
	$parser->parse( $html );
}
